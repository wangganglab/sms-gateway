...
- 🔄 第4批 R5/R4-A：数据基础 ✅（3 新表 + enterprise 扩 6 字段/product 扩 4 字段）；**v4.1 合作方台账 ✅（2026-07-01，扩字段展示/录入+菜单 005007，SQL+部署验证通过）**；v4.2 合作期限预警 / v4.3 号码台账 / v4.4 投诉 / v4.5 聚合视图 / v4.6 拒收识别 ⏭ 逐片交付（见 `docs/plan-r4-slices.md`）

...
<form class="layui-form" action="/admin/product/addProduct" lay-filter="form" onsubmit="return false;"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" maxlength="64" name="code_Type" placeholder="请输入" autocomplete="off" class="layui-input"/>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="activate_Date" id="activate_Date" placeholder="请选择日期" autocomplete="off" class="layui-input"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">详情</label>
        <div class="layui-input-block">
            <textarea maxlength="1024" name="number_Detail" placeholder="请输入" autocomplete="off" class="layui-textarea"></textarea>
        </div>
    </div>
